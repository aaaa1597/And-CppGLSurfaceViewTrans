...
void Java_com_test_cppglsurfaceviewtrans_NativeFunc_create(JNIEnv *pEnv, jclass type, jint id) {
    gpSufacesLists[id] = new CppGLSurfaceView(id);
}

void Java_com_test_cppglsurfaceviewtrans_NativeFunc_surfaceCreated(JNIEnv *pEnv, jclass type, jint id) {
...
#include <unistd.h>
void Java_com_test_cppglsurfaceviewtrans_NativeFunc_surfaceChanged(JNIEnv *pEnv, jclass type, jint id, jint width, jint height) {
...
void Java_com_test_cppglsurfaceviewtrans_NativeFunc_onDrawFrame(JNIEnv *env, jclass type, jint id) {
...
void Java_com_test_cppglsurfaceviewtrans_NativeFunc_surfaceDestroyed(JNIEnv *pEnv, jclass type, jint id) {
    CppGLSurfaceView *psurface = gpSufacesLists[id];
    psurface->destroy();
}
